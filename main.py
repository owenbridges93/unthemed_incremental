...
if save_data["new_file"]:
    ...
    offline_points = round((time.time() - save_data["last_play_time"]) * (save_data["points_per_second"] + (save_data["autoclicks_per_second"] * save_data["points_per_click"])))
